...
![img](./2st.assets/拓扑图.jpg)

### 环境说明

网络配置：

![image-20220902201716802](./2st.assets/image-20220902201716802.png)

![image-20220902221502005](./2st.assets/image-20220902221502005.png)
...
![image-20220902224528402](./2st.assets/image-20220902224528402.png)



重启，一个不留神进磁盘检测了，让他扫算了。~~然而我虚拟机还是在NAS上的不在本地。。。~~

![image-20220902224701716](./2st.assets/image-20220902224701716.png)

进来了

![image-20220902225317616](./2st.assets/image-20220902225317616.png)
...
![image-20220903163549673](./2st.assets/image-20220903163549673.png)

![image-20220903164500501](./2st.assets/image-20220903164500501.png)



Kali 中尝试访问：

![image-20220903164404229](./2st.assets/image-20220903164404229.png)
...
![image-20220902232152055](./2st.assets/image-20220902232152055.png)

![image-20220902231847909](./2st.assets/image-20220902231847909.png)

![image-20220902231857759](./2st.assets/image-20220902231857759.png)
...
![image-20220903203027582](./2st.assets/image-20220903203027582.png)
...
![image-20220904154513063](./2st.assets/image-20220904154513063.png)
...
![image-20220903203424470](./2st.assets/image-20220903203424470.png)



到 Search Public Registries 里 Search 一下，并抓包看看

![image-20220903212150178](./2st.assets/image-20220903212150178.png)

![image-20220903212428237](./2st.assets/image-20220903212428237.png)



看起来 operator 是可更改的参数，更改后可以引起不同的报错

![image-20220903213155825](./2st.assets/image-20220903213155825.png)

![image-20220903213352928](./2st.assets/image-20220903213352928.png)
...
![image-20220904160410608](./2st.assets/image-20220904160410608.png)
...
![image-20220904163431356](./2st.assets/image-20220904163431356.png)

![image-20220904163651371](./2st.assets/image-20220904163651371.png)
...
![image-20220905193231829](./2st.assets/image-20220905193231829.png)

冰蝎连接，成功：

![image-20220905193450444](./2st.assets/image-20220905193450444.png)



看看系统信息

![image-20220906012948157](./2st.assets/image-20220906012948157.png)

Shell 也返回成功了

![image-20220906013521880](./2st.assets/image-20220906013521880.png)
...
![image-20220906013850233](./2st.assets/image-20220906013850233.png)
...
![image-20220906014757932](./2st.assets/image-20220906014757932.png)
...
![image-20220906235842928](./2st.assets/image-20220906235842928.png)



生成后门

![image-20220906155511478](./2st.assets/image-20220906155511478.png)



上传后门

![image-20220906235950361](./2st.assets/image-20220906235950361.png)
...
![image-20220907000127567](./2st.assets/image-20220907000127567.png)



用 BypassAV, Restorator，再加壳，手动云查杀一下看看结果：

![image-20220907153445579](./2st.assets/image-20220907153445579.png)
...
![image-20220907155321492](./2st.assets/image-20220907155321492.png)



提权

![image-20220907162927468](./2st.assets/image-20220907162927468.png)
...
![image-20220907163238560](./2st.assets/image-20220907163238560.png)
...
![image-20220908182619727](./2st.assets/image-20220908182619727.png)



IP 信息

![image-20220908183702411](./2st.assets/image-20220908183702411.png)
...
![image-20220908184546973](./2st.assets/image-20220908184546973.png)
...
![image-20220909000002317](./2st.assets/image-20220909000002317.png)

201：

![image-20220909000024118](./2st.assets/image-20220909000024118.png)
